...
export function TopBar() {
  return (
    <div
      ...
      className="flex w-full justify-center border-b border-monochrome-9">
      <nav className="max-w-1440 sticky top-0 flex h-[76px] w-full items-center justify-between   px-2">
