            ...
            <div className="flex w-full items-start justify-center">
              <div
                ...
                <div className="inset-0 flex flex-col justify-center">
                  <div className="my-4 flex justify-center">
                    <img
                      ...
                      decoding="async"
                      className="h-[45vh]"
                      src={socialConnections1.src}
                    />
                  </div>
                  <div className="flex w-full justify-between">
                    <hr className="w-3/12 border-b-2" />
                    <hr className="w-3/12 border-b-2 border-new-light-grey" />
                    <hr className="w-3/12 border-b-2 border-new-light-grey" />
                  </div>
                  <div className="min-h-40">
                    <p className="my-4 text-new-h4-mobile">Content Marketing</p>
                    <p className="my-4 text-new-para-2">
                      Transform your social media presence with Genuin. Craft engaging short videos that resonate with
                      your community, driving conversations, and fostering genuine connections.
                    </p>
                    <Button variant={'outline'} size="custom" className="my-1 px-4 py-2">
                      <p className="text-new-para-2">Experience SMS Revolution</p>
                    </Button>
                ...
                <div className="absolute flex flex-col justify-center opacity-0">
                  ...
                  <div>
                    <p className="my-4 text-new-h4-mobile">SEO Tools</p>
                    <p className="my-4 text-new-para-2">
                ...
                <div className="absolute flex flex-col justify-center opacity-0">
                  ...
                  <div>
                    <p className="my-4 text-new-h4-mobile">Social Media Ads</p>
                    <p className="my-4 text-new-para-2">
                      Transform your social media presence with Genuin. Craft engaging short videos that resonate with
                      your community, driving conversations, and fostering genuine connections.
                    </p>
