    ...
    case 'light':
      buttonVariant = (
        <button onClick={onClick} className={buttonClasses}>
          ...
          <div
            className={`absolute inset-0 -left-full w-full bg-white transition-all duration-700 ease-out group-hover:left-0 group-hover:right-0 ${radius}`}></div>
          <span
            className={`relative flex items-center gap-3 text-white transition-colors duration-300 group-hover:text-blue`}>
            {children}
    ...
    case 'blue':
      buttonVariant = (
        <button onClick={onClick} className={`${buttonClasses} bg-blue shadow`}>
          ...
          <div
            className={`absolute inset-0 -left-full w-full bg-blue-600 transition-all duration-700 ease-out group-hover:left-0 group-hover:right-0 ${radius}`}></div>
          <span className={`relative flex items-center gap-3 text-white transition-colors duration-300`}>
            {children}
      ...
      buttonVariant = (
        <button onClick={onClick} className={buttonClasses}>
          ...
          <div
            className={`absolute inset-0 -left-full w-full bg-white transition-all duration-700 ease-out group-hover:left-0 group-hover:right-0 ${radius}`}></div>
          <span
            className={`relative flex items-center gap-3 text-black transition-colors duration-300 group-hover:text-blue`}>
            {children}
