...
export function TopBar({
  ...
  return (
    <>
      <div className="z-[1000] flex h-[76px] w-full justify-center border-b border-monochrome-9  bg-monochrome-white sm:flex">
        {isLoading ? (
          ...
          <nav className="sticky top-0 z-[1000] flex h-full w-full items-center justify-between gap-6 px-2 2xl:container xl:px-10 2xl:px-0">
