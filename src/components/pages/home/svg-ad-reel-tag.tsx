...
export function SVGAdReelTag() {
  // return (
  //   <>
  //     <svg width="317" height="651" viewBox="0 0 317 651" fill="none" xmlns="http://www.w3.org/2000/svg">
  //       <foreignObject xmlns="http://www.w3.org/1999/xhtml" x="7" y="5" width="300" height="600">
  //         <iframe style={{ height: '596px', width: '298px' }}>
  //           <div
  //             className="gen-ext"
  //             data-tag-id="2454"
  ...
  return (
    <>
      <div className="relative " style={{ height: '596px', width: '298px' }}>
        <div
          className="gen-ext"
          data-tag-id="2454"
          data-company-id="1129"
          style={{ height: '596px', width: '298px', marginTop: '3px', margin: 'auto', marginBottom: '40px' }}></div>
        <Image className="absolute inset-0 z-[99999]" src={imgMobileFrame} alt="frame" />
      </div>
