        ...
        <div className="container flex h-full flex-col gap-y-6">
          <div className="flex w-full items-end pt-7">
            <div className="flex w-full flex-col gap-y-2 pt-24">
              ...
              <h5 className="text-new-h5 text-new-off-white max-w-2xl">
            ...
            <Button
              size="index-page"
              variant="default"
              className="bg-new-off-black hover:bg-new-dark-grey after:bg-new-dark-grey">
              <p className="text-new-off-white whitespace-nowrap text-new-md">Download Genuin</p>
            </Button>
          </div>
          <div
            className="bg-new-off-black flex flex-col gap-y-10 px-20 pb-8 pt-12 text-primary-foreground"
      ...
      <footer className="relative bg-primary lg:hidden">
        <div className="container flex h-full flex-col gap-y-6">
          <div className="mt-5 flex flex-col items-center justify-center gap-y-2">
            <p className="text-new-h2-mobile text-new-off-white text-center">Join the world of Genuin.</p>
            <Button
              size="index-page"
              variant="default"
              className="bg-new-off-black hover:bg-new-dark-grey after:bg-new-dark-grey mt-3">
              <p className="text-new-off-white whitespace-nowrap text-new-md">Download Genuin</p>
            </Button>
          </div>
          <div
            className="bg-new-off-black mt-5 flex justify-between gap-y-10 p-5 text-primary-foreground"
            style={{ borderRadius: '20px 20px 0px 0px' }}>
            <GenuinLogo.text variant="light" />
            <p>© 2023 Genuin Inc.</p>
          </div>
