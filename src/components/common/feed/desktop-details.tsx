  ...
  if (videoDetails)
    return (
      <div className="relative flex h-full flex-1 flex-col overflow-x-clip bg-monochrome-white pb-16 pl-2">
        <div className="border-tertiary-300 border-b p-4">
        ...
        <div ref={scrollDivRef} className="flex h-full flex-col overflow-auto overflow-x-clip">
            ...
            <div className="pt-3">
              ...
              <DecorativeList>
                ...
                <Link href={PATH_NAME.loop(videoDetails.loop.slug)}>
                  <li className="border-tertiary-300 relative flex h-full w-full items-center justify-between rounded-md border bg-monochrome-white p-4 ">
          ...
          <div className="sticky top-0 z-10">
            <p className="border-tertiary-300 text-tertiary border-b border-t bg-monochrome-white px-4 py-3 text-title-3-demi">
