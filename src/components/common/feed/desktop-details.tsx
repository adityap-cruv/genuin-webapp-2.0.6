  ...
  if (videoDetails)
    return (
      <div className="relative flex h-full flex-1 flex-col overflow-x-clip bg-monochrome-white pb-16 pl-2">
        <div className="border-b border-tertiary-300 p-4">
        ...
        <div ref={scrollDivRef} className="flex h-full flex-col overflow-auto overflow-x-clip">
            ...
            <div className="pt-3">
              ...
              <DecorativeList>
                ...
                <Link href={PATH_NAME.loop(videoDetails.loop.slug)}>
                  <li className="relative flex h-full w-full items-center justify-between rounded-md border border-tertiary-300 bg-monochrome-white p-4 ">
          ...
          <div className="sticky top-0 z-10">
            <p className="border-b border-t border-tertiary-300 bg-monochrome-white px-4 py-3 text-title-3-demi text-tertiary">
...
function CommentInput({ setComments, currentComment, setCurrentComment, videoDetails }: any) {
  ...
  return (
    <div className="min-h-16 absolute bottom-0 left-0 w-full border-t-2 border-t-tertiary-200 bg-tertiary-200 py-3 shadow-md">
