...
export function Component({
  ...
  return (
    <div className={cn('relative max-w-sm', className)} {...props}>
      <Link href={{ pathname: PATH_NAME.loop(loopSlug) }}>
        <div
          className={cn(
          ...
          <div className="w-[70%] items-center p-[3%]">
            <p className="text-body-1-bold">{name}</p>
          ...
          <div
            ...
            <p className="my-[2%] line-clamp-2 w-[70%] text-body-1-demi text-secondary-300">{description}</p>
