  ...
  return (
    <div className="relative w-96">
      <Input
        ...
        placeholder="Search"
      />
      <Search className="absolute left-3 top-0 flex h-full w-4 items-center stroke-tertiary stroke-2" />
    </div>
  )
}
    ...
    <div className="flex w-full items-center border-b border-tertiary-200 px-4 py-2">
      ...
      <span className="relative w-full">
        <Input
          ...
          placeholder="Search"
        />
        <Search className="absolute left-2 top-0 flex h-full items-center stroke-tertiary stroke-2" />
      </span>
    </div>
  )
}
