...
const InputComponent = React.forwardRef<HTMLInputElement, InputProps>(({ className, ...props }, ref) => (
  <Input
    className={cn("border-tertiary-300 bg-tertiary-100 ml-2 rounded-lg border", className)}
    {...props}
    ref={ref}
    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          type="button"
          variant={"outline"}
          className={cn("border-tertiary-300 bg-tertiary-100 flex gap-1 rounded-lg pr-1 pl-3")}
          disabled={disabled}>
