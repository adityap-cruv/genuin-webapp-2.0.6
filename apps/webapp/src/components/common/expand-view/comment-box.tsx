...
const ExpandViewCommentBoxLayout = ({ videos, currentIndex }: ExpandViewCommentBoxProps) => {
...
const FullScreenCommentBox = ({ videos, currentIndex, isMobileCommentView }: ExpandViewCommentBoxProps) => {
...
export default ExpandViewCommentBoxLayout
