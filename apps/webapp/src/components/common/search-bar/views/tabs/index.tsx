...
export default function Component() {
  ...
  return (
    <Tabs className="h-full w-full" defaultValue={defaultTab} value={defaultTab}>
      <TabsList className="border-b-monochrome-8 bg-monochrome-white [&_p]:text-body-1-bold sticky top-0 z-10 flex w-full border-b">
        <TabsTrigger
          value="TOP"
          className="px-0"
          onClick={() => {
      ...
      <TabsContent value="POSTS" className="overflow-auto pb-10">
        <div className="pt-4 pb-16 sm:py-4">
...
function CompShimmer() {
  return (
    <div>
      <div className="border-tertiary-200 flex h-full w-full justify-evenly gap-x-2 border-b p-2">
      ...
      <div className="flex flex-col gap-y-3 px-4 py-4">
        ...
        <div className="border-tertiary-200 flex w-full flex-col gap-y-3 rounded-md border p-4">
        ...
        <Shimmer className="h-4 w-1/4" />
        <div className="border-tertiary-200 relative h-48 w-full overflow-clip rounded-xl border">
          <div className="flex h-1/3 w-full flex-col justify-center gap-y-2 px-4">
            <Shimmer className="h-4 w-1/3" />
            <Shimmer className="h-4 w-1/2" />
          </div>
          <div className="border-tertiary-200 flex h-2/3 w-full flex-col justify-center gap-y-2 border-t px-4">
            <Shimmer className="h-4 w-1/5" />
            <Shimmer className="h-4 w-1/2" />
            <Shimmer className="h-4 w-1/3" />
            <Shimmer className="h-4 w-1/2" />
          </div>
          <div className="absolute top-1/2 right-4 h-5/6 w-1/4 -translate-y-1/2">
