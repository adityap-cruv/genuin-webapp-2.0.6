  ...
  providers: [
    CredentialsProvider({
      ...
      authorize(credentials, request) {
        ...
        const email =
          credentials.email === "undefined" || credentials.email === "null" ? "" : String(credentials.email);
        ...
        const birth =
          credentials.birth === "undefined" || credentials.birth === "null" ? "" : String(credentials.birth);
