...
const ROUTES = [
  // Architect checked first — most specific structural intent
  {
    ...
    keywords: [
      'monorepo', 'package placement', 'adr', 'system design', 'scalability',
      'where should this live', 'which package', 'trade-off', 'trade off',
      'folder structure', 'file structure', 'how to organize', 'which approach',
      'best way to structure', 'should i use', 'where do i put',
  ...
  // they caused planner to shadow debugger/implementer on nearly every prompt.
  {
    ...
    keywords: [
      'plan', 'how should i', "what's the best approach",
      'what would you recommend', 'how do i structure',
      'how does this work', 'walk me through', 'step by step',
      'understand the flow', 'investigate flow', 'deep dive',
    ],
  },
  {
    agent: { name: 'implementer', file: '.claude/agents/implementer.md' },
    keywords: [
      'implement', 'build ', 'add ', 'create ', 'write ', 'make a',
      'add feature', 'write code for',
      'generate', 'scaffold', 'extend', 'integrate',
      'migrate', 'convert',
    ],
  },
  {
    ...
    keywords: [
      'review', 'check this', 'look at this', 'is this correct', 'is this good',
      'what do you think of this code', 'give me feedback on', 'code review',
      'take a look', 'can you check', 'any issues with', 'does this look',
      'review my', 'can i improve', 'is there anything wrong', 'feedback on this',
    ],
  },
  {
    agent: { name: 'typescript-reviewer', file: '.claude/agents/typescript-reviewer.md' },
    keywords: [
      'typescript review', 'type safety', 'ts review', 'review this pr',
      'review pr', 'check types',
      ...
      'typing issue', 'type this', 'proper types', 'strict types',
    ],
  },
  {
    ...
    keywords: [
      'debug', 'fix', 'broken', 'error', 'not working', 'failing', 'crash',
      'exception', 'why is this', "what's wrong", 'troubleshoot', 'investigate',
      'stuck', 'no output', 'silent', 'trace', "what's happening",
      "why is it stopping", 'verify', "can't figure out",
      "doesn't work", "isn't working", 'not rendering', 'not showing', 'not loading',
      'undefined', 'null pointer', 'issue with', 'problem with', 'something wrong',
      'wrong output', 'unexpected behavior', 'not found', 'failed to',
      "why isn't", 'why is it not', 'still not',
  ...
  },
  {
    ...
    keywords: [
      'security', 'audit', 'vulnerability', 'is this safe', 'secure',
      'exploit', 'pentest', 'injection', 'auth issue', 'permissions',
      'xss', 'csrf', 'sanitize', 'exposed secret', 'token leak',
      'can someone attack', 'malicious input',
    ],
  },
  {
    ...
    keywords: [
      'e2e', 'end-to-end', 'playwright', 'user flow',
      'integration test', 'write a test for',
      'test the flow', 'test scenario', 'test this feature',
    ],
  },
  {
    ...
    keywords: [
      'prd', 'product requirements', 'write a spec',
      'feature spec', 'requirements doc',
      'document the feature', 'write requirements', 'user story', 'acceptance criteria',
    ],
  },
];
...
const SKILL_ONLY_ROUTES = [
  {
    ...
    keywords: [
      'performance', 'slow', 'optimize', 'bundle size', 'memory leak', 'render', 'lighthouse',
      'too slow', 'takes too long', 'lcp', 'cls', 'fcp', 'web vitals', 'lazy load',
    ],
  },
  {
    skill: { name: 'accessibility', file: '.claude/skills/accessibility/SKILL.md' },
    keywords: [
      'accessibility', 'wcag', 'a11y', 'aria', 'screen reader', 'keyboard nav',
      'tab order', 'focus trap', 'alt text', 'color contrast',
    ],
  },
  {
    skill: { name: 'refactor', file: '.claude/skills/refactor/SKILL.md' },
    keywords: [
      'refactor', 'restructure', 'clean up', 'reorganize', 'simplify',
      'too complex', 'hard to read', 'messy', 'improve readability', 'extract',
    ],
  },
  {
    skill: { name: 'test-runner', file: '.claude/skills/test-runner/SKILL.md' },
    keywords: [
      'vitest', 'unit test', 'jest', 'write tests', 'test coverage',
      'test this function', 'add tests', 'missing tests', 'test suite',
    ],
  },
  {
    skill: { name: 'frontend-patterns', file: '.claude/skills/frontend-patterns/SKILL.md' },
    keywords: [
      'component', 'hook', 'react', 'context', 'state', 'tanstack', 'server component',
      'client component', 'server action', 'form', 'modal', 'ui', 'tailwind',
      'custom hook', 'use effect', 'use state', 'compound component', 'render prop',
      'next.js', 'app router', 'page component', 'layout', 'suspense',
    ],
  },
];
