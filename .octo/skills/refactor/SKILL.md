...
**When to use:** Restructuring, renaming, or cleaning up existing code without changing its observable behaviour — refactoring, simplifying, deduplicating, or reorganising code.

**Do NOT use for:** Fixing bugs (use the debug skill) or adding features (use the implementer agent).
