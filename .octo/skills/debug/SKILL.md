---
name: debug
description: Diagnose and fix runtime errors, failing tests, and unexpected behaviour in this repo — reproduce, localise, hypothesise, verify, minimal fix — with the repo's specific gotchas (Turborepo cache, pnpm workspace resolution, Next.js 15 async params, Tailwind v4 class renames, NextAuth v5). Use when something is broken, throwing, crashing, or behaving unexpectedly. Do NOT use for writing new tests (use test-runner or e2e-testing) or behaviour-preserving cleanups (use refactor).
---

# Debug

**When to use:** All debugging tasks — runtime errors, failing tests, unexpected behaviour, and production incidents. Reach for it whenever something is broken, throwing, crashing, or behaving unexpectedly. It defines the methodology, output format, and patterns to check first.

**Do NOT use for:** writing new tests (use test-runner or e2e-testing) or behaviour-preserving cleanups (use refactor).
