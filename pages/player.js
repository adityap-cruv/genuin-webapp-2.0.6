            ...
            <Card style={{ width: "auto", borderRadius: "10px" }}>
              <div className="main-meddle">
                <Card.Body className="p-0">
                  <Container fluid="md">
                    <Row
                      className="bg-white d-flex-video desktop_white_video_flex_card"
                      style={{
                        borderRadius: "10px",
                        overflow: "hidden",
                        height: "100vh",
                    ...
                    >
                      <Col
                        md={6}
                        className="adjust_height_for_link_preview padding-0 w-100"
                        style={{
                          width: "auto",
                          maxWidth: "40%",
                          flexBasis: "auto",
                      ...
                      fontSize: '18pt'
                        ...
                        >
                          ...
                          >
                            <img
                              src={require("../images/ic_replies.png")}
                              alt=""
                              style={{
                                width: "15%",
                                color: "white",
                          ...
                          >
                            <img
                              src={require("../images/ic_views.png")}
                              alt=""
                              style={{
                                width: "15%",
                                color: "white",
                        ...
                        <div className="my app-download">
                          ...
                          <div className="mobile-app-download-btn">
                            <div className="inner-block">
                              <Card>
                                <img
                                  ...
                                  height={42}
                                  className="mr-2"
                                  src={require("../images/Genuin_icon_48_new.png")}
                                  alt="Generic"
                                />
                                <Card.Body>
                                  <h5>Genuin App</h5>
                            ...
                            <div className="btn-width">
                              <a href={this.props.installUrl} target="_blank">
                                Install
                              </a>
                            </div>
                          </div>
                      ...
                      <Col
                        ...
                        style={{
                          ...
                          maxWidth: "60%",
                          flexBasis: "60%",
                          height: `calc(100% - ${tmpHeight}px) !important`,
                        }}
                      >
                        <div
                          className="content"
                        ...
                        <div className="url-block" style={{ width: "100%" }}>
                          ...
                          >
                            ...
                            {/* </Link> */}
                            &nbsp;to reply and make genuin connection
                          </div>
                          <div
                          ...
                          >
                            ...
                            <img src={require('../images/ic_whatsapp.png')} />
                                ...
                                <FontAwesomeIcon
                                  icon={faWhatsapp}
                                  style={{ color: "#333333", height: "24px" }}
                                />
                              </Link>
                            </WhatsappShareButton>
                            <LinkedinShareButton url={this.state.urlToCopy}>
                      ...
                      <Col
                        md={12}
                        className="d-none-v bg-white padding-0"
                        style={{ height: "103px" }}
                      >
                        <div
                          className="linkPreview d-none-v"
                          style={{ marginTop: "7px" }}
                        >
                          {preview}
                        </div>
