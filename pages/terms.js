                      ...
                      <ul className="nav flex-column w-100">
                        <li className="nav-item delay-1 pt-4">
                          <a
                            ...
                            onClick={this.handleInvestClick}
                            href="#"
                          >
                            Invest in Genuin
                          </a>
                        ...
                        <li className="nav-item delay-2">
                          <a
                            className="nav-link"
                            onClick={this.handleHireLinkClick}
                            href="#"
                          >
                            Join us
                          </a>
            ...
            >
              ...
              <div className="content-block mobile-p mt-5 pt-5">
                ...
                <p>
                  ...
                  materials (information or software) on Genuin Inc.’s website
                ...
                <p>
                  ...
                  contained on Genuin Inc.’s website;{" "}
                </p>
                ...
                <p>
                  ...
                  of these restrictions and may be terminated by Genuin Inc. at
                ...
                <p>
                  In no event shall Genuin Inc. or its suppliers be liable for
                  any damages (including, without limitation, damages for loss
                  of data or profit, or due to business interruption) arising
                  out of the use or inability to use the materials on Genuin
                  Inc.’s website, even if Genuin Inc. or a Genuin Inc.
                ...
                <p>
                  Genuin Inc. may revise these terms of service for its website
