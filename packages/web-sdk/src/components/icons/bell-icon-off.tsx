...
type Props = Readonly<
  ComponentProps<'svg'> &
    VariantProps<typeof bellVariant> & {
...
export function BellIconOff({ variant = 'light', ...props }: Readonly<Props>) {
  return (
    // SVG element representing the bell icon
    <svg
      width='24'
      height='24'
      viewBox='0 0 24 24'
      ...
      />
      {/* Path for the bell's clapper outline */}
      <path
        d='M10.1053 18.5C10.1053 19.6046 11.0121 20.5 12.1306 20.5C13.2492 20.5 14.1559 19.6046 14.1559 18.5'
        stroke='white'
        strokeWidth='1.5'
      ...
      <circle
        ...
        className={bellVariant({ variant, type: 'stroke' })}
      />
      {/* Path for the bell's diagonal line */}
      <path
        d='M21 3L3 21'
        stroke='white'
        strokeWidth='1.5'
      ...
      <path
        ...
        className={bellVariant({ variant, type: 'fill' })}
      />
      {/* Path for the bell's bottom part */}
      <path
        ...
        className={bellVariant({ variant, type: 'fill' })}
      />
      {/* Path for the bell's right side */}
      <path
