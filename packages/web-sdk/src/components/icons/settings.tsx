...
export function AccountIcon({ isActive, ...props }: Props) {
  return (
    <svg
      width='32'
      height='32'
...
export function PersonalizationIcon({ isActive, ...props }: Props) {
  return (
    <svg
      width='32'
      height='32'
...
export function ContactUsIcon({ isActive, ...props }: Props) {
  return (
    <svg
      width='32'
      height='32'
