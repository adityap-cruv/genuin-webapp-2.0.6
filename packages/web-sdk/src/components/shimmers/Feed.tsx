...
function feed({
  ...
  return (
    <div className='relative overflow-x-hidden __gen__sdk__hide__scrollbar h-full w-full'>
      <div
        className='relative border-2 border-tertiary-100 rounded-xl'
        style={{
        ...
        {customizations.is_show_view_count && (
          <Shimmer
            className='absolute left-4 z-10 h-8 w-8 border border-tertiary-100 shadow-md bg-tertiary-100 rounded-md'
            style={{ top: 'calc(90% - 48px)' }}
          />
        )}
        {/* mute/unmute play/pause fullscreen section */}
        <div className='absolute z-10 top-2 right-4 flex gap-4'>
          <Shimmer className='h-8 w-8 rounded-full border-tertiary-100 shadow-md bg-tertiary-100' />
          <Shimmer className='h-8 w-8 rounded-full border-tertiary-100 shadow-md bg-tertiary-100' />
          <Shimmer className='h-8 w-8 rounded-full border-tertiary-100 shadow-md bg-tertiary-100' />
        </div>
        ...
        {customizations.is_show_social_interaction_data && (
          <div className='absolute w-full bottom-0 flex justify-around items-center h-[10%]'>
            <Shimmer className='h-8 w-8 rounded-md border-tertiary-100 bg-tertiary-100' />
            <Shimmer className='h-8 w-8 rounded-md border-tertiary-100 bg-tertiary-100' />
            <Shimmer className='h-8 w-8 rounded-md border-tertiary-100 bg-tertiary-100' />
          </div>
        )}
