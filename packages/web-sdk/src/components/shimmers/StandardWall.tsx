  ...
  return (
    <div className='absolute inset-0 h-full w-full bg-black'>
      ...
      <div className='absolute bottom-0 left-0 h-auto w-full px-2'>
        <div className='mb-3 flex w-full'>
          <div className='flex w-full flex-col justify-end'>
            <div className='flex items-center gap-x-2'>
              <Shimmer className='h-7 w-7 shrink-0 rounded-full bg-tertiary-300' />
              <Shimmer className='h-3 w-1/5 rounded-full bg-tertiary-300' />
              <Shimmer className='h-3 w-1/6 rounded-full bg-tertiary-300' />
            </div>
            <Shimmer className='my-2 h-3 w-11/12 rounded-full bg-tertiary-300' />
            <Shimmer className='h-3 w-11/12 rounded-full bg-tertiary-300' />
          </div>
          <div className='pl-2'>
            <ActionItem />
            <ActionItem />
        ...
        <Shimmer className='my-2 h-14 w-full bg-tertiary-300' />
      </div>
    </div>
  )
}
...
function ActionItem() {
  return <Shimmer className='my-4 h-6 w-6 shrink-0 bg-tertiary-300' />
}
  ...
  return (
    <div className='absolute inset-0 flex h-full w-full'>
      ...
      <div className='relative h-full w-full flex-1 p-6'>
        ...
        <div className='mt-4 border-b-2 border-t-2 border-tertiary-300 p-4'>
          ...
          <div className='my-4 flex w-full'>
            ...
            <div className='w-full'>
              ...
              <div className='flex w-full justify-between rounded-xl border-2 border-tertiary-300 p-4'>
        ...
        <div className='border-b-2 border-tertiary-300 py-4'>
          <Shimmer className='h-4 w-1/3' />
        </div>
        <div className='w-full py-2'>
          <Comments iterations={5} />
        </div>
        <div className='absolute bottom-0 right-0 flex w-full items-center gap-x-4 border-t-2 border-tertiary-200 bg-tertiary-100 p-2'>
          <div className='w-full rounded-full border-2 border-tertiary-300 py-2 pl-2'>
