...
if (existsSync(mkcertKeyPath) && existsSync(mkcertCertPath)) {
  ...
  console.log(chalk.green("✅ Using mkcert certificates for HTTPS (supports network access)"));
  ...
  console.log(chalk.yellow("⚠️ Using custom certificates for HTTPS (may be localhost only)"));
} else {
