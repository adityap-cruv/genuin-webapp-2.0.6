...
function validateEnvironment() {
  ...
  if (!fs.existsSync(path.resolve(process.cwd(), envFile))) {
    ...
    console.log("2. Contact your team lead to get the correct environment values");
    console.log(`3. Update ${envFile} with the values provided by your team lead\n`);
    process.exit(1);
  }
  ...
  if (!fs.existsSync(path.resolve(process.cwd(), envCommonFile))) {
    ...
    console.log("Please pull the latest changes from the repository or contact your team lead.\n");
    process.exit(1);
  }
