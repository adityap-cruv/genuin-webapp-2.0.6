...
1. **Bundle Loading Test**
   ...
   <script src="dist/genuin-sdk.js"></script>        <!-- Dev build -->
   <script src="dist/genuin-sdk.min.js"></script>    <!-- Prod build -->
...
<body>
    ...
    <div class="test-section">
        ...
        <div class="test-demo">
            <div id="style-demo" class="bg-primary text-white p-4 rounded-lg hidden">
