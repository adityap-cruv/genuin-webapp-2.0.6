/**
 * Bunny CDN Purge Script for Storybook Deployments
 * =================================================
 *
 * This script handles purging Bunny CDN cache after Storybook builds are uploaded
 * to Oracle Object Storage. It provides functionality to purge specific paths based
 ...
 *
 * @param {string[]} uploadPaths - The Oracle upload paths that were used
 ...
 *
 * @param {string[]} uploadPaths - The Oracle upload paths that were used for deployment
 * @returns {Promise<void>}
 */
