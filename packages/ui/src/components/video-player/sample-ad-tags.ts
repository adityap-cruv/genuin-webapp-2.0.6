...
/** Google IMA sample ad tags for development and QA. Not for production use. */
export const SAMPLE_AD_TAGS = {
  /** Linear pre-roll — autoplay-safe with muted+playsinline. */
  PRE_ROLL:
  ...
  /** Linear pre-roll with skip button. */
  SKIPPABLE:
  ...
  VMAP_PRE_MID_POST_WITH_BUMPERS:
