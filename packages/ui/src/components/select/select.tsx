...
function SelectLabel({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.Label>) {
  return (
    <SelectPrimitive.Label
      ...
      className={cn("gencl:text-body-2-medium gencl:px-2 gencl:py-1.5 gencl:text-secondary-600", className)}
      {...props}
    />
  );
}
...
function SelectSeparator({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.Separator>) {
  return (
    <SelectPrimitive.Separator
      ...
      className={cn("gencl:bg-border gencl:pointer-events-none gencl:-mx-1 gencl:my-1 gencl:h-px", className)}
      {...props}
    />
  );
}
...
function SelectScrollUpButton({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.ScrollUpButton>) {
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={cn("gencl:flex gencl:cursor-default gencl:items-center gencl:justify-center gencl:py-1", className)}
      {...props}>
