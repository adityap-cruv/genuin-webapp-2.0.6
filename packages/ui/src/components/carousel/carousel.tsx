...
import { Button, ButtonPropsType } from "src/components/button"
    ...
    return (
        ...
        >
            <div
                className={cn(
                    "gencl:flex",
                    orientation === "horizontal" ? "gencl:-ml-4" : "gencl:-mt-4 gencl:flex-col",
                    className
                )}
                {...props}
            />
        ...
        <button
          ...
          className={cn(
            ...
            index === current
              ...
              : cn("gencl:bg-primary/30 hover:gencl:bg-primary/50", dotClassName)
          )}
