...
function RadioGroup({ className, ...props }: RadioGroupProps) {
  return <RadioGroupPrimitive.Root className={cn("gencl:grid gencl:gap-2", className)} {...props} />;
}
...
function RadioItem({ className, value, label, disabled, ...props }: RadioItemProps) {
  return (
    <div
      className={cn(
