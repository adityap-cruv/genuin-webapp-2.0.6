...
export function ClockIcon({ className, variant, ...restProps }: SVGIconsProps & VariantProps<typeof iconVariants>) {
  return (
    <svg
      width="24"
      height="24"
      ...
      />
      <path d="M12 6.375V12L15.75 13.875" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
