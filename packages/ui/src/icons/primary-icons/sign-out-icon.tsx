...
export function SignOutIcon({ ...restProps }: SVGIconsProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" {...restProps}>
      ...
      />
      <path d="M16 17L21 12L16 7" stroke="#1D1F20" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M21 12H9" stroke="#1D1F20" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
