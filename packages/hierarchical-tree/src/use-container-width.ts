 ...
 * apply padding / border to the page root report the inner width,
 * matching the size the walker actually fills.
 *
 * Duplicated from `packages/components/src/legacy/hierarchical-grid/use-container-width.ts`
 * for v0 — see {@link HIERARCHICAL_TREE_RUNTIME_WALKER_PLAN.md} for
 * the locked decision to duplicate rather than cross-import.
 */
