...
export function PlayerHeader({
  ...
  return (
    ...
    >
      ...
      >
        <ChevronLeftIcon className="gencl:size-6 gencl:text-white" />
      </Button>
      <p className="gencl:flex-1 gencl:line-clamp-1 gencl:text-center gencl:font-semibold gencl:text-[18px] gencl:text-white gencl:leading-[24px] gencl:tracking-[-2%]!">
        {title}
      </p>
    </div>
  );
