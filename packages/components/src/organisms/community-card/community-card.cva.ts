  ...
  "gencl:flex gencl:flex-col gencl:overflow-clip gencl:w-full gencl:h-full gencl:cursor-pointer",
  {
    variants: {
      variant: {
        ...
        search: "gencl:p-4 gencl:rounded-[10px] gencl:border gencl:border-secondary-150",
        suggestion:
          "gencl:p-3 gencl:rounded-lg gencl:hover:bg-secondary-50 gencl:cursor-pointer gencl:transition-colors",
        recent: "gencl:p-3 gencl:rounded-lg gencl:hover:bg-secondary-50 gencl:cursor-pointer gencl:transition-colors",
      },
    },
    defaultVariants: {
      variant: "explore",
...
export type CommunityCardVariant = VariantProps<typeof communityCardVariants>["variant"];
