...
/**
 * Calculates the visibility percentage of a slide at the given index
 * @param swiper The Swiper instance
 * @param index The slide index to check
 * @param isFeed Whether the layout is a vertical feed (true) or horizontal carousel (false)
 * @returns The percentage of the slide that is visible (0-100)
 */
export function getSlideVisibilityPercentage({
  swiper,
  index,
  isVertical,
}:{
