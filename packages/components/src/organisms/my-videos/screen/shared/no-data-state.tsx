...
export function NoDataState({ title, description, buttonLabel, onButtonClick }: NoDataStateProps) {
  return (
    <div className="gencl:flex gencl:flex-col gencl:items-center gencl:justify-center gencl:h-full gencl:bg-white gencl:rounded-xl gencl:border gencl:border-secondary-100">
      ...
      <span className="gencl:text-body-1-medium gencl:text-secondary-600 gencl:mb-4">{description}</span>
