...
const meta: Meta<typeof EditCoverImage> = {
  ...
  tags: ["autodocs"],
  args: {
    videoURL: "https://media.begenuin.com/temp_video/67345114261af9b41c83dd80_1743510621960.mp4",
...
function DefaultStory(args: ComponentProps<typeof EditCoverImage>) {
  const ref = useRef<EditCoverImageHandle>(null);

  const handleCapture = async () => {
    await ref.current?.captureImage();
  };
