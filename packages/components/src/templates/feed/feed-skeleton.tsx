  ...
  return (
    <div className="gencl:grid gencl:py-4 gencl:w-full gencl:h-full gencl:grid-cols-2 gencl:ml-6 gencl:gap-6">
      ...
      <div className="gencl:w-full gencl:grid gencl:overflow-auto gencl:gap-4 gencl:grid-rows-[auto_minmax(200px,1fr)]">
        <div className="gencl:border gencl:border-secondary-150 gencl:p-4 gencl:rounded-2xl gencl:h-[calc(100%-1px)]">
        ...
        <div className="gencl:relative gencl:border gencl:border-secondary-150 gencl:p-4 gencl:rounded-2xl">
          ...
          <div className="gencl:absolute gencl:bg-white gencl:bottom-0 gencl:right-0 gencl:flex gencl:w-full gencl:items-center gencl:justify-between gencl:gap-x-4 gencl:border-t gencl:border-secondary-150 gencl:p-4">
