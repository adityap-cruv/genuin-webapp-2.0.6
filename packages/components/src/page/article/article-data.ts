...
export const ARTICLE_CONTENT: ArticleContentMap = {
  ...
  "how-pace-took-line-honours-in-the-2026-round-britain-and-ireland-race-one-chapter-at-a-time": {
    ...
    "standfirst": "Johnny Vincent's Volvo 70 Pace crossed the Royal Yacht Squadron line off Cowes at 04:17:31 BST on Sunday 16 August, taking monohull line honours in the 2026 RORC Round Britain and Ireland Race. Six days, 14 hours, 47 minutes and 31 seconds after the cannon fired, Vincent - an owner rather than a professional sailor - had sailed the 1,805 nautical miles around Britain and Ireland and come home first, in the 50th anniversary edition of one of offshore racing's most unrelenting challenges.",
    "author": "Benedict Donovan, Deputy Editor",
  ...
  "the-questions-that-remain-following-new-york-sailgp": {
    ...
    "standfirst": "The New York SailGP left us with more questions than answers. From a dramatic three-boat collision to a grand final that divided opinion, the sixth round of the season gave the league plenty to reflect on ahead of Halifax.",
  ...
  "the-real-story-behind-the-black-foils-new-sailgp-recruits": {
    ...
    "standfirst": "New Zealand's Black Foils have added two sailors to their crew roster, but only one has officially been announced.",
    "author": "Lewis Smith, Multimedia Editor",
    ...
    "body": [
      ...
      },
      {
        ...
        "caption": "Black Foils / SailGP - Stewart donning her new Black Foils uniform for a photoshoot ahead of the annoucnement at SailGP Technologies"
      },
      {
        "type": "heading",
      ...
      },
      {
        ...
        "caption": "Black Foils / SailGP - Coach booth operator Will McKenzie (right) alongside head coach Matt Steven (left)"
      },
      {
        "type": "paragraph",
  ...
  "the-safest-is-when-you-re-pushing-hard-billy-gooderham-explains-flight-control": {
    ...
    "body": [
      ...
      },
      {
        ...
        "caption": "Ricardo Pinto / SailGP. The most isolated job on board: flight controllers operate in a narrow window where every input directly shapes lift, speed, and safety. Leo Takahashi, Japan SailGP Team, Season 2"
      },
      {
        "type": "heading",
      ...
      },
      {
        ...
        "caption": "Ricardo Pinto / SailGP. Flat-out flight: at these speeds, the flight controller constantly balances maximum performance with the structural limits of the platform. Perth, Season 6"
      },
      {
        "type": "heading",
  ...
  "the-week-in-racing-10-august-26": {
    ...
    "standfirst": "This week saw the Olympic fleets sign off a globe-trotting season on LA's 2028 waters, both New Zealand and France back in their AC75s, plus the start of a 1,805-mile epic around Britain and Ireland. Let's get into it!",
    "author": "Benedict Donovan, Deputy Editor",
  ...
  "podcast-it-starts-with-a-dream-glenn-ashby-on-australia-s-ac38-challenge-the-foil-podcast-ep-20": {
    ...
    "standfirst": "\"The time is now,\" decorated sailor Glenn Ashby tells The Foil's Freddie Carr in an exclusive interview on Team Australia's newly-minted challenge for the 38th America's Cup.",
  ...
  "emirates-dubai-sail-grand-prix-presented-by-dp-world": {
    ...
    "standfirst": "Dubai has been a calendar fixture since Season 3, maintaining its presence through commercial considerations alongside varying wind conditions.",
    "heroImage": {
  ...
  "mubadala-abu-dhabi-sail-grand-prix-2026-season-grand-final-presented-by-abu-dhabi-sports-council": {
    ...
    "standfirst": "The season culminates in Abu Dhabi with predictable conditions of flat water and fickle breezes, where light-wind racing determines the championship outcome.",
    "heroImage": {
  ...
  "rockwool-germany-sail-grand-prix-sassnitz": {
    ...
    "standfirst": "The Season 5 debut venue proved exceptional despite its remote location, featuring flat water and reliable wind conditions where Denmark set a new SailGP speed record of 103.93 km/h.",
    "heroImage": {
  ...
  "rolex-switzerland-sail-grand-prix-geneva": {
    ...
    "standfirst": "SailGP has raced at some stunning locations, but Geneva might just top the lot. A vast freshwater lake ringed by snow-capped Alps, with the city's elegant waterfront providing a postcard-perfect backdrop.",
    "heroImage": {
  ...
  "spain-sail-grand-prix-valencia": {
    ...
    "standfirst": "Valencia is back on sailing's grand stage. Nearly two decades after hosting the America's Cup, the Spanish city returns to top-flight racing with a three-year SailGP commitment running through 2028.",
    "heroImage": {
