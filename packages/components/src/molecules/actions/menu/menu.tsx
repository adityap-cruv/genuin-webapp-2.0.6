...
export function Menu({
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen} {...props}>
      ...
      <PopoverContent
        align="start"
        className="gen-sdk-class gencl:w-fit gencl:p-3 gencl:border gencl:border-secondary-100 gencl:rounded-xl gencl:flex gencl:flex-col gencl:gap-0.5 gencl:z-50 gencl:!bg-white gencl:focus-visible:outline-none gencl:focus-visible:ring-0"
      >
        {MenuData.map((data, index) => (
          <React.Fragment key={index}>{data.children}</React.Fragment>
        ))}
