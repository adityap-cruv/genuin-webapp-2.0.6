      ...
      <DialogContent
        ...
        <DialogHeader
          className={cn(
            ...
            isTablet ? "gencl:text-headline-2-semi-bold!" : "gencl:text-body-0-semi-bold"
          )}>
          Playback Speed
        </DialogHeader>
        <p className="gencl:text-headline-4-semi-bold gencl:text-secondary-900">{playbackSpeed.speed}x</p>
