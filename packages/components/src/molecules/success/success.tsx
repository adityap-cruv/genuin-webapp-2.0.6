...
export function Success({ className, text, description, button, onClose }: SuccessProps) {
  return (
    <div
      className={cn(
      ...
      <Image alt="Success" src={`${MEDIA_BASE_URL}/web-sdk/v1/icons/success.gif`} className="gencl:h-36" />
      <div className="gencl:flex gencl:flex-col gencl:gap-2">
        <p className="gencl:text-body-0-semi-bold gencl:sm:text-headline-4-semi-bold!">{text}</p>
        {description && (
