...
export const WalmartEmbed: FC<ControlLayerPropsType> = ({ postDetails, className, isActive, ...restProps }) => {
  return (
    <div
      ...
      <div className="gencl:absolute gencl:bottom-0 gencl:p-2 gencl:space-y-2 gencl:w-full">
        <p className="gencl:text-body-1-semi-bold gencl:text-white gencl:line-clamp-1">{postDetails.section?.title}</p>
      </div>
    </div>
  );
};
