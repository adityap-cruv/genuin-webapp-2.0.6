...
export const Controls = memo(function Controls({
  ...
  return (
    <div
      className={cn(
        "gencl:absolute gencl:transition-all gencl:z-20 gencl:flex gencl:w-full gencl:sm:bg-gradient-to-b gencl:from-black/50 gencl:to-transparent gencl:top-16 gencl:sm:top-0 gencl:justify-between gencl:items-center gencl:gap-3 gencl:px-4 gencl:sm:p-4",
