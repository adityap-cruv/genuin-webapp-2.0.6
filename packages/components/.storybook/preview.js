...
const preview = {
  decorators: [
    (Story, context) => {
      ...
      const { feedData: _feedData, wasLazilyLoaded: _wasLazilyLoaded, ...embedArgs } = context.args;
      ...
      if (context.kind.toLowerCase().includes("web-sdk") || context.title.toLowerCase().includes("web-sdk")) {
        ...
        return _jsx("div", {
          ...
          style: { ...parsedColor },
          children: _jsx(ReactQueryClientProvider, {
            children: _jsx(EmbedProvider, {
              container: document.getElementById("gen-sdk"),
              embedData: embedData,
              brandLayoutType: {},
              children: _jsx(BaseContextProvider, {
                useShadowDOM: false,
                brandDetails: testBrandDetails,
                isEmbed: true,
                children: _jsx(LinkProvider, {
                  children: _jsx(AuthProvider, {
                    onSignIn: () => {},
                    onSignOut: () => {},
                    onUpdateUser: () => {},
                    user: null,
                    children: _jsxs(AnalyticsProvider, {
                      isWebSDK: true,
                      brandDetails: {},
                      user: null,
                      children: [_jsx(Story, {}), _jsx(Toaster, {})],
                    }),
                  }),
                }),
              }),
      ...
      const parsedColor = parseBrandColors(testBrandDetails.brand_colors);
      return _jsx(ReactQueryClientProvider, {
        children: _jsx(BaseContextProvider, {
          useShadowDOM: false,
          isEmbed: false,
          brandDetails: testBrandDetails,
          children: _jsx(LinkProvider, {
            children: _jsx(AuthProvider, {
              ...
              children: _jsx(AnalyticsProvider, {
                user: null,
                brandDetails: {},
                children: _jsxs("main", { style: { ...parsedColor }, children: [_jsx(Story, {}), _jsx(Toaster, {})] }),
              }),
            }),
          }),
        }),
